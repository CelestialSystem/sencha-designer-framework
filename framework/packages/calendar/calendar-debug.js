...
Ext.define('Ext.calendar.panel.Base', {
    ...
    updateHighlightToday: Ext.emptyFn,
    /**
...
Ext.define('Ext.calendar.panel.Days', {
    ...
    configExtractor: {
        ...
        view: {
            ...
            /**
             * @cfg highlightToday
             * @inheritdoc Ext.calendar.view.Days#cfg-highlightToday
             * @since 7.0
             */
            highlightToday: true
        }
...
Ext.define('Ext.calendar.panel.Weeks', {
    ...
    configExtractor: {
        ...
        view: {
            ...
            /**
             * @cfg highlightToday
             * @inheritdoc Ext.calendar.view.Weeks#cfg-highlightToday
             * @since 7.0
             */
            highlightToday: true
        }
...
Ext.define('Ext.calendar.view.Month', {
    ...
    privates: {
        ...
        $todayCellHighlightCls: Ext.baseCSSPrefix + 'today-cell-highlight',
        trackRanges: true,
        /**
...
Ext.define('Ext.calendar.panel.Month', {
    ...
    updateHighlightToday: function(highlightToday) {
        ...
        cellEl = view.element.selectNode('td[data-date="' + domFormat + '"]', false);
        if (cellEl) {
...
Ext.define('Ext.calendar.panel.Week', {
    ...
    updateHighlightToday: function(highlightToday) {
        var view = this.getView(),
            ...
            headerEl, domFormat;
        domFormat = Ext.Date.format(new Date(), header.domFormat);
        headerEl = header.element.selectNode('td[data-date="' + domFormat + '"]', false);
        if (headerEl) {
...
Ext.define('Ext.calendar.panel.Panel', {
    ...
    config: {
        ...
        /**
         * @cfg {Boolean} highlightToday
         * `true` to highlight today's date cell.
         * `false` not to highlight today's date.
         * @since 7.0
         */
        highlightToday: true,
        /**
    ...
    privates: {
        ...
        createView: function() {
            ...
            return {
                ...
                value: me.getValue(),
                views: me.getViews(),
                highlightToday: me.getHighlightToday(),
                listeners: {
                    scope: me,
