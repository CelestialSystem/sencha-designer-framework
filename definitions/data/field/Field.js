xds.component.Registry.addDefinition({
    ...
    // [basedata] This array is used while duplicating instances to ignore configs to be copied over.
    ...
    cfgs: [{
        ...
        merge: true,
        required: true,
        regex: xds.Resource.get('validFieldName').regex,
        regexText: xds.Resource.get('validFieldName').regexText
    }, {
        name: 'sortType',
        merge: true,
        type: 'string',
        ...
        name: 'type',
        group: '(Architect)',
        type: 'string', //don't allow references
